...
final class FacultyTable extends PowerGridComponent
{
    ...
    *
    * @return Builder<\App\Models\Faculty>
    */
    ...
    */
     ...
     /**
     * PowerGrid Faculty Action Buttons.
     *
       ...
       return [
        ...
        //        ->method('delete'),
           ...
           Button::add('view')
               ...
               ->openModal('faculty.update', ['facultyId' => 'id'])
    ...
    */
     ...
     /**
     * PowerGrid Faculty Action Rules.
     *
      ...
      */
      ...
      public function delete(): void
      {
          ...
          if(count($this->checkboxValues)>1){
              ...
              Faculty::find($this->checkboxValues[0])->delete();
          }
